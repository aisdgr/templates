# devSCR-CNL (Constraint Normative Language) README

---

## 1. Purpose

devSCR-CNL defines a **controlled normative language** for expressing
**mandatory behavioral constraints** to AI systems.

devSCR-CNL is designed to:
...
devSCR-CNL applies to **any interaction where AI behavior must be constrained**.
...
devSCR-CNL restricts normative modality to a minimal, explicit set:
...
The following words introduce ambiguity and **MUST NOT appear** in CNL:
...
> **CNL MUST NOT contain ambiguity or optionality.**

---

## 5. Sentence Structure

devSCR-CNL follows a constrained sentence structure to reduce ambiguity
...
devSCR-CNL strongly prefers **artifact-oriented subjects**
...
devSCR-CNL remains a **language discipline**, not a programming language.

---

## 6. Examples

This section provides **illustrative examples** of devSCR-CNL usage.
...
The devSCR-CNL schema exists **to constrain language**, not to execute logic.
...
devSCR-CNL is not about making AI smarter.
...
devSCR-CNL reduces AI behavior from **unbounded interpretation**  
to **controlled variability**.

---

**devSCR-CNL is language — but it is constrained language.**
