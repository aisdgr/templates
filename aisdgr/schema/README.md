...
AI Struct Language (BRA) is a layered language system designed to define, constrain, and stabilize AI behavior through explicit structure rather than implicit interpretation.
...
Modern AI systems are highly capable of inference, but this strength introduces a fundamental risk: **semantic drift**.
...
Instead of relying on hidden system prompts or opaque policies, makes constraints explicit, layered, and inspectable.
...
4. **Separation of concerns**  
   Semantic expression, behavioral rules, and document structure are isolated into distinct layers.

---

## Language Layers

is not a single language. It is a **language family** composed of four cooperating layers.
...
**Role:**  
RNL is the *authoritative expression* of normative behavior.

Only statements written in RNL are considered behavior-defining.
...
**Structure:**
- A single authoritative RNL description
...
Enumerations are intentionally allowed here, as they describe static structure rather than semantic intent.
...
Execution, validation, enforcement, auditing, and governance are expected to exist *above* or *beside* BRA, not inside it.

---

## Relationship to AIGDMM

serves as the **language foundation** of AIGDMM (AI-Guided, Document-Driven Methodology).
...
This separation ensures that AI behavior remains understandable, inspectable, and evolvable over time.

---

## Guiding Principle

> **AI should not guess what we mean. We should structure what we mean.**
...
Extensions may be introduced, but the foundational principles are expected to remain unchanged.
