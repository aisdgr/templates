# AIGDMM
## AI-Governed Document-Driven Methodology
...
This document is the **authoritative normative specification** of AIGDMM.

All document classes, governance rules, constraints, trace mechanisms,
and precedence relationships defined herein are **binding**.

Any conceptual, explanatory, or illustrative documents
(including *AIGDMM_Conceptual_Model.md*)
are **informative only**.

> In case of any inconsistency, **this document SHALL prevail**.

---

## 1. Purpose

AIGDMM defines a document-driven governance methodology
for AI-assisted software development and execution.

Its purpose is to:

- explicitly define document authority and responsibility,
- constrain AI behavior through explicit governance constraints,
- separate semantics, engineering, governance, execution, and evidence,
- enable auditability, non-repudiation, and controlled evolution,
- and prevent uncontrolled AI-driven drift.

AIGDMM treats documents as **governance primitives**,  
not as AI-generated artifacts or transient contexts.
...
All **normative documents** are human-owned.

AI MAY read documents according to governance constraints,  
but **MUST NOT** generate, modify, or extend
normative documents unless explicitly allowed.

---

### 2.2 Class-Based Governance

All documents are classified by **governance role**,  
not by format, tooling, or storage medium.

Document class determines:
