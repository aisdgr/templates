# CNL (Constraint Normative Language) README

---

## 1. Purpose

CNL defines a **controlled normative language** for expressing
...
CNL applies to **any interaction where AI behavior must be constrained**.
...
CNL restricts normative modality to a minimal, explicit set:
...
CNL follows a constrained sentence structure to reduce ambiguity
...
CNL strongly prefers **artifact-oriented subjects**
...
CNL remains a **language discipline**, not a programming language.

---

## 6. Examples

This section provides **illustrative examples** of CNL usage.
...
The CNL schema exists **to constrain language**, not to execute logic.
...
CNL is not about making AI smarter.
...
CNL reduces AI behavior from **unbounded interpretation**  
to **controlled variability**.

---

**CNL is language — but it is constrained language.**
